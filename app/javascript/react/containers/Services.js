...
import HomepageHeading from '../components/HomepageHeading'
 ...
 const panes = [
   ...
   { menuItem: 'Interstate Moving', render: () =>
        <Tab.Pane>
         <Segment  vertical>
            <Grid container stackable verticalAlign='middle'>
              <Grid.Row>
   ...
   { menuItem: 'Packing Service', render: () =>
        <Tab.Pane>
         <Segment  vertical>
            <Grid container stackable verticalAlign='middle'>
              <Grid.Row>
   ...
   { menuItem: 'Storage Service', render: () =>
          <Tab.Pane>
           <Segment  vertical>
              <Grid container stackable verticalAlign='middle'>
                <Grid.Row>
