...
import {  Select, Container, Segment, Header } from 'semantic-ui-react'
          ...
          >
            ...
            <Form.Row>
              <Form.Group as={Col} md="6" >
                ...
                >
                {
                      movingTypeOptions.map((item, index) => {
                        if(item.value == ""){
                          return(
                            <option key={item.key} value=''>Type From...</option>
                          )
              ...
              <Form.Group as={Col} md="6" >
                ...
                >
                {
                      movingTypeOptions.map((item, index) => {
                        if(item.value == ""){
                          return(
                            <option key={item.key} value=''>Type To...</option>
                          )
                        }else if(item.value == "Stairs 5th or Higher - N/A"){
                          return (
                              <option key={item.key} value={item.value} disabled>{item.text}</option>
              ...
              <Form.Group controlId="formGridAddress1">
                ...
                >
                {
                      movingSizeOptions.map((item, index) => {
                        if(item.value == ""){
                          return(
